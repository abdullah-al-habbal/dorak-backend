---
name: translation-conventions
description: Translation file structure, key naming, retrieval via TranslatorHandlerService, and enum-integrated messages. Use whenever adding or retrieving user-facing strings.
---
