---
name: how-to-add-a-module
description: Step-by-step guide to scaffold a new module: directory structure, service provider, route wiring, bootstrap registration. Use whenever creating a new domain module.
---
